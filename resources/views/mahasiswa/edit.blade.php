...
<div class="container-fluid">
    ...
    <div class="box-body">
        <div class="form-group @error('nim') has-error @enderror">
            ...
            <input type="number" class="form-control" value="{{$mahasiswa->nim}}" name="nim" id="nim" placeholder="NIM">
        @error('nis')
        ...
        <div class="form-group @error('nama') has-error @enderror">
            ...
            <input type="text" class="form-control" value="{{$mahasiswa->nama}}" name="nama" id="nama" placeholder="Nama">
        @error('nis')
            <div class="invalid-feedback text-danger">
                {{ $message }}
            </div>
        ...
        <div class="form-group @error('jenis_kelamin') has-error @enderror">
            ...
            <div class="radio">
                <label>
                  <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="1" {{$mahasiswa->jenis_kelamin == 1 ? 'checked' : ''}} >
                  Laki-laki
                </label>
                <label>
                    <input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="0" {{$mahasiswa->jenis_kelamin == 0 ? 'checked' : ''}}>
                    Perempuan
                  </label>
            </div>
            @error('jenis_kelamin')
        ...
        <div class="form-group @error('tanggal_lahir') has-error @enderror">
            ...
            <div class="input-group date">
              ...
              <input type="text" data-date-format="yyyy-mm-dd" name="tanggal_lahir" value="{{$mahasiswa->tanggal_lahir}}" class="form-control pull-right" id="datepicker">
            </div>
            @error('tanggal_lahir')
            <div class="invalid-feedback text-danger">
                {{ $message }}
        ...
        <div class="form-group @error('alamat') has-error @enderror">
            ...
            <input type="text"alamat class="form-control" value="{{$mahasiswa->alamat}}" name="alamat" id="alamat" placeholder="Nama">
        @error('nis')
            <div class="invalid-feedback text-danger">
                {{ $message }}
            </div>
